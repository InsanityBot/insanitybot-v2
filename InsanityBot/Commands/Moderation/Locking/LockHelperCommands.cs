...
namespace InsanityBot.Commands.Moderation.Locking
{
	...
	public class LockHelperCommands : BaseCommandModule
	{
		...
		public class Whitelist : BaseCommandModule
		{
			...
			{
				await this.AddWhitelistedRoleCommand(ctx, role, ctx.Channel);
			}
			...
			{
				await this.RemoveWhitelistedRoleCommand(ctx, role, ctx.Channel);
			}
		...
		public class Blacklist : BaseCommandModule
		{
			...
			{
				await this.AddBlacklistedRoleCommand(ctx, role, ctx.Channel);
			}
			...
			{
				await this.RemoveBlacklistedRoleCommand(ctx, role, ctx.Channel);
			}
